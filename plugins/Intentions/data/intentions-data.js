/**
 * Intentions Data - Intentions neutres et labels
 */

// Intentions neutres (fallback)
export const NEUTRAL_INTENTIONS = {
    fr: [
...
export const LABELS = {
    fr: {
        ...
        success: 'Bravo ! Tu as pris un engagement 💪'
    },
    en: {
        ...
        success: 'Great! You made a commitment 💪'
    },
    ar: {
        title: 'نية اليوم',
        engage: 'ألتزم بهذا',
