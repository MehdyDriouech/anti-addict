/**
 * i18n.js - Internationalisation pour l'application Haven
 * 
 * Fonctionnalités:
...
const FALLBACK_STRINGS = {
    fr: {
        app_name: "Haven",
        app_tagline: "A steady point in the storm",
        today: "Aujourd'hui",
        ...
        export_encrypted: "Export chiffré",
        auto_lock: "Verrouillage automatique",
        auto_lock_enabled: "Activer le verrouillage automatique",
        auto_lock_delay: "Délai de verrouillage",
        auto_lock_delay_30s: "30 secondes",
        auto_lock_delay_1min: "1 minute",
        auto_lock_delay_2min: "2 minutes",
        auto_lock_delay_5min: "5 minutes",
        auto_lock_delay_10min: "10 minutes",
        auto_lock_disabled: "Désactivé",
        auto_lock_description: "Verrouille automatiquement l'application après une période d'inactivité",
        export_encrypt_confirm: "Chiffrer avec mon PIN ?",
        import_password_required: "Mot de passe requis",
        import_password_prompt: "Entrez votre PIN pour déchiffrer les données",
        import_password_incorrect: "PIN incorrect",
        import_password_placeholder: "PIN",
        export_no_password_warning: "Aucun PIN défini. Les données seront exportées en clair.",
        language: "Langue",
        religion: "Religion",
        ...
        coaching: "Coaching",
        "coaching.insight.weekly_summary": "Cette semaine: {cravings} urgences, {wins} victoires.",
        "coaching.insight.avg_intensity": "Intensité moyenne cette semaine: {avg}.",
        "coaching.insight.week_comparison": "Cette semaine est plus chargée que la précédente.",
        "coaching.insight.suggested_actions": "Actions suggérées disponibles.",
        "coaching.not_useful": "Pas utile",
        "coaching.useful": "Utile",
        "coaching.no_insight_yet": "Pas encore d'insight disponible",
        "coaching.no_insight_available": "Pas encore d'insight disponible. Reviens plus tard.",
        "coaching.what_app_observes": "Ce que l'app observe",
        "coaching.observation_text": "Analyse sur {days} jours ({sampleSize} échantillons)",
        "coaching.suggested_actions": "Actions suggérées",
        "coaching.create_rule": "Créer une règle",
        "coaching.history": "Historique",
        "coaching.personalized_advice": "Conseils personnalisés",
        "coaching.advice.retrospective": "Rétrospectif",
        "coaching.advice.preventive": "Préventif",
        "coaching.advice.prescriptive": "Prescriptif"
    },
    en: {
        app_name: "Haven",
        app_tagline: "A steady point in the storm",
        ...
        auto_lock_delay: "Lock delay",
        auto_lock_delay_30s: "30 seconds",
        auto_lock_delay_1min: "1 minute",
        auto_lock_delay_2min: "2 minutes",
        auto_lock_delay_5min: "5 minutes",
        auto_lock_delay_10min: "10 minutes",
        ...
        export_encrypt_confirm: "Encrypt with my PIN?",
        import_password_required: "Password required",
        import_password_prompt: "Enter your PIN to decrypt the data",
        import_password_incorrect: "Incorrect PIN",
        import_password_placeholder: "PIN",
        export_no_password_warning: "No PIN defined. Data will be exported in plain text.",
        language: "Language",
        religion: "Religion",
        religion_none: "None",
        religion_islam: "Islam",
        ...
        coaching: "Coaching",
        "coaching.insight.weekly_summary": "This week: {cravings} emergencies, {wins} wins.",
        "coaching.insight.avg_intensity": "Average intensity this week: {avg}.",
        "coaching.insight.week_comparison": "This week is busier than the previous one.",
        "coaching.insight.suggested_actions": "Suggested actions available.",
        "coaching.not_useful": "Not useful",
        "coaching.useful": "Useful",
        "coaching.no_insight_yet": "No insight available yet",
        "coaching.no_insight_available": "No insight available yet. Come back later.",
        "coaching.what_app_observes": "What the app observes",
        "coaching.observation_text": "Analysis over {days} days ({sampleSize} samples)",
        "coaching.suggested_actions": "Suggested actions",
        "coaching.create_rule": "Create a rule",
        "coaching.history": "History",
        "coaching.personalized_advice": "Personalized advice",
        "coaching.advice.retrospective": "Retrospective",
        "coaching.advice.preventive": "Preventive",
        "coaching.advice.prescriptive": "Prescriptive"
    },
    ar: {
        app_name: "Haven",
        app_tagline: "A steady point in the storm",
        ...
        auto_lock_enabled: "تفعيل القفل التلقائي",
        auto_lock_delay: "تأخير القفل",
        auto_lock_delay_30s: "30 ثانية",
        auto_lock_delay_1min: "دقيقة واحدة",
        auto_lock_delay_2min: "دقيقتان",
        auto_lock_delay_5min: "5 دقائق",
        auto_lock_delay_10min: "10 دقائق",
        auto_lock_disabled: "معطّل",
        auto_lock_description: "يقفل التطبيق تلقائياً بعد فترة من عدم النشاط",
        export_encrypt_confirm: "تشفير برمز PIN الخاص بي؟",
        import_password_required: "كلمة المرور مطلوبة",
        import_password_prompt: "أدخل رمز PIN لفك تشفير البيانات",
        import_password_incorrect: "رمز PIN غير صحيح",
        import_password_placeholder: "PIN",
        export_no_password_warning: "لم يتم تعريف رمز PIN. سيتم تصدير البيانات كنص عادي.",
        language: "اللغة",
        religion: "الدين",
        religion_none: "بدون",
        ...
        coaching: "تدريب",
        "coaching.insight.weekly_summary": "هذا الأسبوع: {cravings} حالات طوارئ، {wins} انتصارات.",
        "coaching.insight.avg_intensity": "متوسط الكثافة هذا الأسبوع: {avg}.",
        "coaching.insight.week_comparison": "هذا الأسبوع أكثر ازدحامًا من الأسبوع السابق.",
        "coaching.insight.suggested_actions": "إجراءات مقترحة متاحة.",
        "coaching.not_useful": "غير مفيد",
        "coaching.useful": "مفيد",
        "coaching.no_insight_yet": "لا توجد رؤية متاحة بعد",
        "coaching.no_insight_available": "لا توجد رؤية متاحة بعد. عد لاحقًا.",
        "coaching.what_app_observes": "ما تلاحظه التطبيق",
        "coaching.observation_text": "تحليل على مدى {days} أيام ({sampleSize} عينات)",
        "coaching.suggested_actions": "إجراءات مقترحة",
        "coaching.create_rule": "إنشاء قاعدة",
        "coaching.history": "التاريخ",
        "coaching.personalized_advice": "نصائح مخصصة",
        "coaching.advice.retrospective": "رجعي",
        "coaching.advice.preventive": "وقائي",
        "coaching.advice.prescriptive": "وصفي"
    }
};
...
async function loadSpiritualCards(lang, religion) {
    ...
    try {
        ...
        // Fallback sur les cartes embarquées SEULEMENT si la religion est islam
        // Sinon, laisser vide pour éviter d'afficher des références à l'islam
        if (religion === 'islam') {
            ...
            console.warn(`[i18n] Pas de fallback disponible pour la religion ${religion}`);
            currentSpiritualCards = [];
        }
        return true;
    }
 ...
 * @param {string} addictionId - ID de l'addiction pour filtrer (optionnel)
 * @returns {Array}
 */
function getSpiritualCards(addictionId = null) {
    let cards = currentSpiritualCards || [];
    
    // Filtrer par addiction si spécifiée
    if (addictionId) {
        cards = cards.filter(c => c.addiction === addictionId || c.addiction === 'any');
    }
